...
#             |___/
#
# Description: This nagios plugin will list all processes that consume more
#     memory than the given warn / crit thresholds.  Returns OK otherwise
# Notes: thresholds are all converted to KB for comparisions and only
#        translated to MB / GB for display purposes
#
...
#            nearest GB
#
#     type check to ensure crit and warn are ints vs stack trace
#
# Author: d_k_nguyen_at_yahoo.com
# Date: 7/15/2013
